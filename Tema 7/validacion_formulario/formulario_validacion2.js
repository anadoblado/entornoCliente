...
var estatura=document.getElementById("estatura1");
...
hermanos.addEventListener("change",activarsubmit);
fechanac.addEventListener("change",activarsubmit);
estatura.addEventListener("change",activarsubmit);
